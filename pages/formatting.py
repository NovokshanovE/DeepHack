#Автоматическое оформление источников по ГОСТ
...
local_css("style.css")
st.markdown("# Автоматическое оформление источников по ГОСТ")
...
#st.sidebar.header("Автоматическое оформление источников по ГОСТ")
